...
export function ClearButton({ name }) {
    ...
    return (
        <button onClick={() => setUserInput("")} >{name}</button>
    );
}
...
export function BackButton({ name }) {
    ...
    return (
        <button onClick={undo} >{name}</button>
    );
}
...
export function ForwardButton({ name }) {
    ...
    return (
        <button onClick={redo} >{name}</button>
    );
}
...
export function RadButton({ name }) {
    ...
    return (
        <button id="rad" onClick={buttonClick} >{name}</button>
    );
}
...
export function DegButton({ name }) {
    ...
    return (
        <button id="deg" onClick={buttonClick} >{name}</button>
    );
}
